...
# do(equil(M, X = x))
do_equil_experiment_1a <- mapk_ode_equilM(states = initial_states, rates,
                                          TRaf = 100, TMek = 100, TErk = 100,
                                          intervention_experiment_1a)()



plot(times, out_meta_model_ai_experiment_1a$PRaf, type = 'l', col = 'darkgreen', ylim = c(0, 110), ylab = 'amount')
  lines(out_meta_model_ai_experiment_1a$PPMek, type= 'l', col = 'darkblue', ylim = c(0, 110))
  lines(out_meta_model_ai_experiment_1a$PPErk, type= 'l', col = 'darkred', ylim = c(0, 110))
  abline(h = do_equil_experiment_1a$PRaf, col = 'darkgreen', lty = 2)
  abline(h = do_equil_experiment_1a$PPMek, col = 'darkblue', lty = 2)
  abline(h = do_equil_experiment_1a$PPErk, col = 'darkred', lty = 2)
  legend(1,114, legend = c("PRaf","PPMek","PPErk"), col = c('darkgreen','darkblue','darkred'), lty = 1)

do_equil_experiment_1a
```
